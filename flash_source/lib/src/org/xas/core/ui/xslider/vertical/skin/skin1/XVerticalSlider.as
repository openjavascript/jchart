package org.xas.core.ui.xslider.vertical.skin.skin1
{
	...
	{		
		...
		override protected function init():void
		{
			...
			_box.addChild( _forwardBtn = new SliderForawrdButton() );
			
			_dragArea = new SliderDragArea();
			_dragArea.y = _forwardBtn.height + 5;
			_box.addChild( _dragArea );
			
			_backwardBtn = new SliderBackwardButton();
			_backwardBtn.y = _dragArea.x + _dragArea.height + 17;
			_box.addChild( _backwardBtn );
			
			_dragBtn = new SliderDragButton();
			...
			addChildAt( _bg = new SliderBg( w, h ), 0 );
			_bg.visible = false;
